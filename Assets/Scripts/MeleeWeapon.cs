...
public class MeleeWeapon : MonoBehaviour
{
    ...
    private bool CheckDamage(Collider other, AttackPoint pts)
    {
        ...
        d.ApplyDamage(new DamageMessage
        {
            damager = this,
            amount = damage,
            hitNormal = (pts.attackRoot.position - other.transform.position).normalized,
            hitPoint = other.ClosestPoint(pts.attackRoot.position)
        });
